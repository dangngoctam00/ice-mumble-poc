...
public interface MetaPrx extends com.zeroc.Ice.ObjectPrx
{
     ...
     **/
    default java.util.Map<String, String> getSliceChecksums()
    {
     ...
     * @return Checksum dict
     **/
    default java.util.Map<String, String> getSliceChecksums(java.util.Map<String, String> context)
    {
     ...
     * @return Checksum dict
     **/
    default java.util.concurrent.CompletableFuture<java.util.Map<String, String>> getSliceChecksumsAsync()
    {
     ...
     * @return Checksum dict
     **/
    default java.util.concurrent.CompletableFuture<java.util.Map<String, String>> getSliceChecksumsAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.util.Map<String, String>> _iceI_getSliceChecksumsAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.util.Map<String, String>> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getSliceChecksums", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     java.util.Map<String, String> ret;
