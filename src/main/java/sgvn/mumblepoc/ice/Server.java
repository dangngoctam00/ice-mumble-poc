...
public interface Server extends com.zeroc.Ice.Object
{
     ...
     **/
    java.util.concurrent.CompletionStage<Float> getListenerVolumeAdjustmentAsync(int channelid, int userid, com.zeroc.Ice.Current current);
     ...
     * @return A completion stage that the servant will complete when the invocation completes.
     **/
    java.util.concurrent.CompletionStage<Void> setListenerVolumeAdjustmentAsync(int channelid, int userid, float volumeAdjustment, com.zeroc.Ice.Current current);
    ...
    **/
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_getListenerVolumeAdjustment(Server obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(com.zeroc.Ice.OperationMode.Idempotent, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        int iceP_channelid;
        ...
        iceP_userid = istr.readInt();
        inS.endReadParams();
        return inS.setResultFuture(obj.getListenerVolumeAdjustmentAsync(iceP_channelid, iceP_userid, current), (ostr, ret) ->
            {
                ostr.writeFloat(ret);
            });
    }
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_setListenerVolumeAdjustment(Server obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(com.zeroc.Ice.OperationMode.Idempotent, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        int iceP_channelid;
        ...
        iceP_channelid = istr.readInt();
        iceP_userid = istr.readInt();
        iceP_volumeAdjustment = istr.readFloat();
        inS.endReadParams();
        return inS.setResultFuture(obj.setListenerVolumeAdjustmentAsync(iceP_channelid, iceP_userid, iceP_volumeAdjustment, current));
    }
    ...
    **/
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        switch(pos)
        {
            ...
            case 13:
            {
                return _iceD_getListenerVolumeAdjustment(this, in, current);
            }
            case 14:
            {
            ...
            case 50:
            {
                return _iceD_setListenerVolumeAdjustment(this, in, current);
            }
            case 51:
            {
