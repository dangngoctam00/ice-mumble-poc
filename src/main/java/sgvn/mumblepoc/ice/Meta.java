...
public interface Meta extends com.zeroc.Ice.Object
{
     ...
     **/
    java.util.concurrent.CompletionStage<java.util.Map<String, String>> getSliceChecksumsAsync(com.zeroc.Ice.Current current);
    ...
    **/
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_getSliceChecksums(Meta obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(com.zeroc.Ice.OperationMode.Idempotent, current.mode);
        inS.readEmptyParams();
        return inS.setResultFuture(obj.getSliceChecksumsAsync(current), (ostr, ret) ->
            {
