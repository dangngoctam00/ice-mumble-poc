...
public interface ServerPrx extends com.zeroc.Ice.ObjectPrx
{
     ...
     **/
    default float getListenerVolumeAdjustment(int channelid, int userid)
    {
        return getListenerVolumeAdjustment(channelid, userid, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }
     ...
     * @return s The volume adjustment set for a listener of the given user in the given channel
     **/
    default float getListenerVolumeAdjustment(int channelid, int userid, java.util.Map<String, String> context)
    {
        return _iceI_getListenerVolumeAdjustmentAsync(channelid, userid, context, true).waitForResponse();
    }
     ...
     * @return s The volume adjustment set for a listener of the given user in the given channel
     **/
    default java.util.concurrent.CompletableFuture<Float> getListenerVolumeAdjustmentAsync(int channelid, int userid)
    {
        return _iceI_getListenerVolumeAdjustmentAsync(channelid, userid, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }
     ...
     * @return s The volume adjustment set for a listener of the given user in the given channel
     **/
    default java.util.concurrent.CompletableFuture<Float> getListenerVolumeAdjustmentAsync(int channelid, int userid, java.util.Map<String, String> context)
    {
        return _iceI_getListenerVolumeAdjustmentAsync(channelid, userid, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Float> _iceI_getListenerVolumeAdjustmentAsync(int iceP_channelid, int iceP_userid, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Float> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getListenerVolumeAdjustment", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeInt(iceP_channelid);
                     ostr.writeInt(iceP_userid);
                 }, istr -> {
     ...
     * @param userid The ID of the user
     **/
    default void setListenerVolumeAdjustment(int channelid, int userid, float volumeAdjustment)
    {
        setListenerVolumeAdjustment(channelid, userid, volumeAdjustment, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }
     ...
     * @param context The Context map to send with the invocation.
     **/
    default void setListenerVolumeAdjustment(int channelid, int userid, float volumeAdjustment, java.util.Map<String, String> context)
    {
        _iceI_setListenerVolumeAdjustmentAsync(channelid, userid, volumeAdjustment, context, true).waitForResponse();
    }
     ...
     * @return A future that will be completed when the invocation completes.
     **/
    default java.util.concurrent.CompletableFuture<Void> setListenerVolumeAdjustmentAsync(int channelid, int userid, float volumeAdjustment)
    {
        return _iceI_setListenerVolumeAdjustmentAsync(channelid, userid, volumeAdjustment, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }
     ...
     * @return A future that will be completed when the invocation completes.
     **/
    default java.util.concurrent.CompletableFuture<Void> setListenerVolumeAdjustmentAsync(int channelid, int userid, float volumeAdjustment, java.util.Map<String, String> context)
    {
        return _iceI_setListenerVolumeAdjustmentAsync(channelid, userid, volumeAdjustment, context, false);
    }
     ...
     * @param iceP_channelid -
     * @param iceP_userid -
     * @param iceP_volumeAdjustment -
     * @param context -
     * @param sync -
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setListenerVolumeAdjustmentAsync(int iceP_channelid, int iceP_userid, float iceP_volumeAdjustment, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setListenerVolumeAdjustment", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeInt(iceP_channelid);
                     ostr.writeInt(iceP_userid);
                     ostr.writeFloat(iceP_volumeAdjustment);
                 }, null);
        return f;
    }
